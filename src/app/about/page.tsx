...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "uriel.seguban@hcdc.edu.ph",
    href: "mailto:uriel.seguban@hcdc.edu.ph",
  ...
  },
  {
    ...
    content: "/uriel-nobela-seguban",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Zumats",
    content: "/Zumats",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Uriel Nobela Seguban</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Uriel Nobela Seguban, a Computer Science Engineer with experience in development, DevOps, and
              database management with hands-on experience in deploying and automating workflows.
              I enjoy solving real-world problems and continuously improving systems through clean engineering.
              Strong analytical skills, effective communication,
