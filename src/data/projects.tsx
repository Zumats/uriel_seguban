...
const projects: Project[] = [
  ...
  // +
  { // 01. AgriDroneInsight project
    id: "agridroneinsight",
    category: "AI and Agriculture",
    title: "AgriDroneInsight", src: "/assets/projects-screenshots/agridroneinsight/landing.png",
   
    screenshots: ["landing.png"],
    live: "https://capstoneproject-webinterface.onrender.com/",
    github:"https://github.com/Zumats",
    skills: {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            AgriDroneInsight is an AI-powered agricultural drone analysis platform for precision 
            farming and crop health monitoring. The platform combines cutting-edge AI technology 
            with agricultural expertise to provide actionable insights for your crops.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
              `${BASE_PATH}/agridroneinsight/landing.png`,
            ]}
          />
        </div>
      );
  ...
  { // 04. Windy weather map
    id: "windy-weather-map",
    category: "Weather",
    title: "Windy: Wind map & weather forecast",
    src: "/assets/projects-screenshots/smartparkingassitant/01.jpeg",
    screenshots: ["01.jpeg", "03.png", "04.jpg"],
    live: "https://www.windy.com/-Waves-waves?waves,14.602,120.990,5,p:cities",
    github:"https://github.com/Zumats",
    skills: {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            Windy is an interactive weather intelligence platform that visualizes global forecast
            layers in real time. This showcase highlights wind and wave map views, satellite
            coverage, and storm tracking to provide a quick, map-first weather forecast experience.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
  ...
  { // 05. Hyperaccess Project Management project
    id: "smartjobtracker",
    category: "Full stack",
    title: "Hyperaccess Project Management",
    src: "/assets/projects-screenshots/smartjobtracker/06.png",
    screenshots: ["01.png", "02.png", "03.png","04.png","05.png","06.png","07.png"],
    live: "https://project.hyperaccess.net/login?back_url=https%3A%2F%2Fproject.hyperaccess.net%2F",
    github:"https://github.com/Zumats",
    skills: {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            Hyperaccess Project Management is a sleek dark-themed dashboard for organizing and
            tracking tasks by status and priority. It provides a clean workspace to manage
            project execution, monitor team activity, and keep work progress visible in one
  ...
  { // 06. Certificates
    ...
    screenshots: ["01.png"],
    live: "https://www.udemy.com/logout/",
    github:"https://github.com/Zumats",
    skills: {
      frontend: [],
      backend: [],
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            This section highlights my professional certificates. Featured here is my Udemy
            completion certificate for &quot;Build Complete CMS Blog in PHP MySQL Bootstrap &amp; PDO&quot;
            by Web Coding, completed on Dec 12, 2024, with a total length of 10 hours.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
